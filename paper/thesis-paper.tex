...
\paragraph{Thesis Statement} Automated testing frameworks for completion systems reveal information and patterns that enable more informed and targeted improvements to such systems.
...
The metrics they used are all similar and help define metrics in a way that works best for such validation systems.
...
For a given token in a source file, the ranker modifies the file at that position, either by removing or truncating as described above, and then invoke an auto-completer to get a list of completion results.
